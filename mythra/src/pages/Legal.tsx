...
export function Terms() {
  return (
    <Shell kicker="Mythio · terms of service" title="Terms of play." updated="September 2026">
      <p><b>1. What this is.</b> Mythio is a proprietary browser mystery game by xtharshh. Playing the hosted game is permitted; everything else — copying, distributing, modifying, claiming it as your own — requires written permission (see LICENSE).</p>
...
export function Privacy() {
  return (
    <Shell kicker="Mythio · privacy policy" title="Your data, plainly." updated="September 2026">
      ...
      <p><b>5. Children.</b> Mythio is a general-audience puzzle game, not directed at under-13s; guardians should supervise young explorers.</p>
